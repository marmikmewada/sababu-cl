  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const memberUpdateFields = {
        ...
        emergencyContact: formData.emergencyContact.map(contact => ({
          relation: contact.relation,
          name: contact.name,
          phone: contact.phone,
          email: contact.email,
          address: {
            apt: contact.address.apt,
      ...
      const householdUpdateFields = {
        spouse: {
          ...
          birthdate: formData.spouse.birthdate,
          sex: formData.spouse.sex,
          nationality: formData.spouse.nationality,
          address: {
            apt: formData.spouse.address.apt,
            street: formData.spouse.address.street,
            city: formData.spouse.address.city,
            state: formData.spouse.address.state,
            zip: formData.spouse.address.zip,
          },
        },
        ...
        adultDependents: formData.adultDependents.map(dependent => ({
          ...
          address: {
            apt: dependent.address.apt,
            street: dependent.address.street,
            city: dependent.address.city,
            state: dependent.address.state,
            zip: dependent.address.zip,
          },
        })),
      };
  
      await updateUserProfile(updateFields);          // Assuming this function updates the user profile
      await updateMemberProfile(memberUpdateFields);  // Assuming this function updates the member profile
      await updateHouseholdProfile(householdUpdateFields);  // Assuming this function updates the household profile
...
//             type="text"
//             name="spouse.street"
//             value={formData.spouse.address.street}
//             onChange={handleChange}
//           />
//         </label>
//         <br />
...
//             type="text"
//             name="spouse.apt"
//             value={formData.spouse.address.apt}
//             onChange={handleChange}
//           />
//         </label>
//         <br />
